...
\begin{table}[t]
\centering
\caption{Hyperparameter search for trace generation (SFT model, 50 problems $\times$ $K$ samples). Higher temperature increases diversity but reduces accuracy. Default: $\tau{=}0.5$, $T_{\max}{=}10$, $K{=}2$.}
